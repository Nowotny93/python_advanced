from python_workshop.python_workshop1.tic_tac_toe.core.validators import is_position_in_range, is_place_available
from python_workshop.python_workshop1.tic_tac_toe.core import (
    get_row_col,
